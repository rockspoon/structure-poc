...
import com.example.poc.server.domain.SendToKitchenUseCase
import io.ktor.http.*
...
fun Route.orderEndpoint(
    sendToKitchenUseCase: SendToKitchenUseCase = SendToKitchenUseCase(object : OrderRepository{})
) {
...
val orderStorage = hashMapOf<Long, Order>()

class OrderEndpoint : Route(
    parent = null,
