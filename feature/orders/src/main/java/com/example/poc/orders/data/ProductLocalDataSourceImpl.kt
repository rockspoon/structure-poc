...
import com.example.poc.core.ui.R
    ...
    companion object {
        val INITIAL_ITEMS = listOf(
            ...
            Product(
                id = 5,
                title = "Big Mac",
                drawableId = R.drawable.ic_fastfood,
            ...
            Product(6, "Fries"),
            Product(7, "Pizza Pasta", R.drawable.ic_local_pizza),
            Product(8, "Ramen", R.drawable.ic_ramen_dining),
            Product(9, "Food"),
            Product(10, "Food"),
            Product(11, "Food"),
            Product(12, "Food"),
