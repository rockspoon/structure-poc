 ...
 * @param itemId Item ID of the bundle item.
 * @param photos
 * @param subcategory
 * @param tags
 * @param title
 ...
 */
@Serializable
data class BundleItemDigestResponse(
    val category: ItemType? = null,
    /** Item description. */
    val description: String? = null,
    /** Item ID of the bundle item. */
    ...
    val modifiers: List<ModifierDigestResponse>? = null,
