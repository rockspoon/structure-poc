...
/**
 * PatchCAPaymentInfo represents a request to patch payment info for a CA
 * order
 *
 ...
 *     my-own
 * @param tips
 * @param preauthAmount preauth amount in cents to allow authorizing a
 *     bigger amount.
 */
@Serializable
data class PatchCAPaymentInfo(
    /** required for not `none` payment type */
    val cctoken: String? = null,
    /** Payment type that should be updated. Default is my-own */
    val paymentType: PaymentType? = null,
    val tips: PatchCAPaymentInfoTips? = null,
    /** preauth amount in cents to allow authorizing a bigger amount. */
    val preauthAmount: Int? = null
)
