 ...
 * @param type
 * @param factor Fee's factor
 * @param effectivePeriod
 * @param progressiveValues
 */
@Serializable
data class CustomFee(
    /** Fee's name */
    val name: String,
    val type: CustomFeeType,
    val effectivePeriod: CustomFeeEffectivePeriod,
    val id: String? = null,
    /** Fee's factor */
    val factor: CustomFeeFactor? = null,
    val progressiveValues: List<CustomFeeProgressiveValue>? = null
)
