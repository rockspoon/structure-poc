...
/**
 * sales report grouped by orderType for the given profile
 *
 * @param profileId
 * @param isThirdParty Flag to indicate whether the order has been placed
 *     from a third-party system
 * @param type
 * @param category
 */
@Serializable
data class OrderTypeSalesReport(
    val profileId: String? = null,
    /**
     * Flag to indicate whether the order has been placed from a third-party
     * system
     */
    val isThirdParty: Boolean? = null,
    val type: OrderTypeDto? = null,
    val category: List<ReportCategory>? = null
)
