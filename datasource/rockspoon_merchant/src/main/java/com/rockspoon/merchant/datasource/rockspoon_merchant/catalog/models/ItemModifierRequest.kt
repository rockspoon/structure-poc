...
/**
 * ModifierResponse is the modifier response for a single modifier
 *
 * @param modifierId
 * @param itemModifierId
 * @param type
 * @param subtype
 * @param title
 ...
 */
@Serializable
data class ItemModifierRequest(
    val type: ModifierType,
    val title: String,
    val itemModifier: ItemModifier,
    val options: List<ModifierOptionRequest>,
    val modifierId: String? = null,
    val itemModifierId: String? = null,
    val subtype: List<String>? = null,
    val titleForCustomers: String? = null,
    val index: Int? = null,
