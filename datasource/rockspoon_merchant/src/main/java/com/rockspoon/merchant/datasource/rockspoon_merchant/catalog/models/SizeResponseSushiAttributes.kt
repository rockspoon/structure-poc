...
/** @param itemsQuantity Quantity of items allowed inside sushi combo */
@Serializable
data class SizeResponseSushiAttributes(
    /** Quantity of items allowed inside sushi combo */
    @Serializable(with = BigDecimalSerializer::class)
    val itemsQuantity: java.math.BigDecimal? = null
)
