 ...
 * @param elements
 * @param position
 * @param order empty if there is no open order
 */
@Serializable
data class FloorPlanSectionElementStatusResponse(
    val type: String? = null,
    val category: String? = null,
    val isBlocked: Boolean? = null,
    val availableForReservation: Boolean? = null,
    val name: String? = null,
    val capacity: FloorPlanSectionElementCapacityResponse? = null,
    val dimensions: FloorPlanSectionElementDimensionsResponse? = null,
    val elementId: String? = null,
    val elements: List<FloorPlanSectionElementStatusResponse>? = null,
    val position: FloorPlanSectionElementPositionResponse? = null,
    /** empty if there is no open order */
    val order: FloorPlanSectionOrderState? = null
)
