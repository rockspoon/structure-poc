...
/**
 * GenericCheck represents the billing of a generic order
 *
 * @param checkId
 * @param orderShortId
 * @param checkShortId
...
data class GenericCheck(
    ...
    val orderShortId: String? = null,
    val checkShortId: String? = null,
    val venueId: String? = null,
    val checkPayer: CheckCustomer? = null,
    val checkCustomer: CheckCustomer? = null,
    val entries: List<OrderCheckEntry>? = null,
    val currency: CurrencyType? = null,
    val waiters: List<String>? = null,
    val grossTotal: String? = null,
    val netTotal: String? = null,
    val tableName: String? = null,
    val tableNumbers: List<String>? = null,
    val tableType: String? = null,
    val checkMeta: CheckMeta? = null,
    val status: CheckStatus? = null,
    val paymentStatus: CheckPaymentStatus? = null,
    val checkType: CheckType? = null,
    val payments: List<CheckPayment>? = null
)
