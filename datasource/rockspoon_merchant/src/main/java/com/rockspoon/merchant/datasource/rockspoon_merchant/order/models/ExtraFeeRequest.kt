...
/**
 * @param id
 * @param name Fee's name
 * @param description Fee's description
 * @param type
 * @param value Fee's value
 * @param isBeforeSalesTax If fee should be applied before tax
 * @param services
 */
@Serializable
data class ExtraFeeRequest(
    ...
    /** If fee should be applied before tax */
    val isBeforeSalesTax: Boolean? = null,
    val services: List<OrderTypeDto>? = null
)
