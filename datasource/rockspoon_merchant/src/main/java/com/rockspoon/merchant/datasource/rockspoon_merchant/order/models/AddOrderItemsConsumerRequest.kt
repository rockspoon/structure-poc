...
/**
 * AddOrderItemsConsumerRequest represents a request to add many orderitems
 * to order via consumerapp
 *
 * @param items
 */
@Serializable
data class AddOrderItemsConsumerRequest(
    val items: List<OrderItemConsumerRequest>
)
