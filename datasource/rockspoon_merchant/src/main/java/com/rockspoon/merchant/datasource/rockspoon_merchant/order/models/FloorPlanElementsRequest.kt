...
/**
 * FloorPlanElementsRequest represents the floor plan elements update
 * request. Pass info inside floorPlanLocations parameter to update
 * locations for an order with merged tables. Otherwise use usual
 * floorPlanSectionID, floorPlanElementIDs properties.
 *
 ...
 */
@Serializable
data class FloorPlanElementsRequest(
    val floorPlanSectionID: String? = null,
    val floorPlanElementIDs: List<String>? = null,
    val floorPlanLocations: List<UpdateFloorPlanLocationRequest>? = null
)
