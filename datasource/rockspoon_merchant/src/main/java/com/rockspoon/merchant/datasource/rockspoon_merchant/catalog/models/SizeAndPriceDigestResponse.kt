...
/**
 * SizeAndPriceDigestResponse is a size digest response
 *
 * @param index
 * @param isMarketPrice
 * @param price
 * @param sizeId
 * @param title
 * @param pizzaAttributes
 * @param comboAttributes
 * @param prixFixeAttributes
 * @param sushiAttributes
 * @param progressivePricing
 * @param bundleItemSizeAttributes
 * @param bundleSectionSizeAttributes
 */
@Serializable
data class SizeAndPriceDigestResponse(
    val index: Long,
    val isMarketPrice: Boolean,
    val price: Long,
    val sizeId: String,
    val title: String,
    val pizzaAttributes: PizzaAttributesRequest? = null,
    val comboAttributes: ComboAttributesRequest? = null,
    val prixFixeAttributes: PrixFixeAttributesRequest? = null,
    val sushiAttributes: SushiAttributesRequest? = null,
    val progressivePricing: List<ProgressivePricingRequest>? = null,
    val bundleItemSizeAttributes: List<ItemBundleItemSizeAttributes>? = null,
    val bundleSectionSizeAttributes: List<ItemBundleSectionSizeAttributes>? = null
)
