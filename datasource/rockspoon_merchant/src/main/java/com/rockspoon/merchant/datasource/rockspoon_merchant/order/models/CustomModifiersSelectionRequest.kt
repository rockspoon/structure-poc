...
/**
 * CustomModifiersSelectionRequest represents a custom modifier.
 *
 * @param description Description of what this modifier refers to
 * @param price Custom modifier price
 */
@Serializable
data class CustomModifiersSelectionRequest(
    /** Description of what this modifier refers to */
    val description: String? = null,
    /** Custom modifier price */
