...
/**
 * SalesReportDiscountType represents discount type for complete sales
 * report. Values: comp,refund,discount,void,cancel
 */
@Serializable
enum class SalesReportDiscountType(val value: String) {
