...
/**
 * represent section sale response
 *
 * @param name represent modifier name
 * @param quantity represent count of modifiers
 * @param total represent total amout of current modifier
 */
@Serializable
data class ItemSale(
    /** represent modifier name */
    val name: String? = null,
    /** represent count of modifiers */
    val quantity: String? = null,
    /** represent total amout of current modifier */
