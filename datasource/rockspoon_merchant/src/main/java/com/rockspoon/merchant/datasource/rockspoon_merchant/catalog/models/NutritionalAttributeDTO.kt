 ...
 * @param amount
 * @param dayPercentage
 * @param subNutritionalAttributes
 */
@Serializable
data class NutritionalAttributeDTO(
    val name: MLCollection? = null,
    val unit: String? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val amount: java.math.BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val dayPercentage: java.math.BigDecimal? = null,
    val subNutritionalAttributes: List<NutritionalAttributeDTO>? = null
)
