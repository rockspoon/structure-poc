...
/**
 * RecipeResponse is the response for an item recipe
 *
 * @param cookingTime
 * @param instructions
 * @param sizeRecipe
...
data class RecipeResponse(
    ...
    val instructions: List<RecipeInstructionResponse>,
    val sizeRecipe: List<SizeRecipeResponse>,
    val itemId: String,
    val measure: Measure,
    val platingTime: Long,
