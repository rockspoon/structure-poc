...
/**
 * Represent aggregation by item and modifier name
 *
 * @param name represents item name
 * @param quantity represent count of items
 * @param total represent total amout of current item
 * @param itemSales
 */
@Serializable
data class ItemGroupSale(
    /** represents item name */
    val name: String? = null,
    /** represent count of items */
    val quantity: String? = null,
    /** represent total amout of current item */
    val total: String? = null,
    val itemSales: List<ItemSale>? = null
)
