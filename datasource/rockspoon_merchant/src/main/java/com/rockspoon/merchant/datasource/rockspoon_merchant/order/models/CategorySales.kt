...
/**
 * Represent aggrefation by category
 *
 * @param category category name
 * @param quantity represent count of categories
 * @param total represent total amout for category
 * @param menuCategorySales
 */
@Serializable
data class CategorySales(
    /** category name */
    val category: String? = null,
    /** represent count of categories */
    val quantity: String? = null,
    /** represent total amout for category */
    val total: String? = null,
    val menuCategorySales: List<SectionSale>? = null
)
