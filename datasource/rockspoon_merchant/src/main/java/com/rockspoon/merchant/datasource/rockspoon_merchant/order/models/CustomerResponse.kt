 ...
 * @param addresses
 * @param cars
 * @param diningStatistics
 * @param orderingStatistics
 */
@Serializable
data class CustomerResponse(
    ...
    val cars: List<CarInfoDto>? = null,
    val diningStatistics: CustomerDiningStatistics? = null,
    val orderingStatistics: Map<String, String>? = null
)
