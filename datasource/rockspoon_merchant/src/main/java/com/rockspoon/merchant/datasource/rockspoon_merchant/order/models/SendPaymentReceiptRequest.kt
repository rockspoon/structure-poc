...
/**
 * SendPaymentReceiptRequest represents send payment receipt request.
 *
 * @param email
 * @param phone
 * @param securityDepositId
 * @param giftCardReceipt
 */
@Serializable
data class SendPaymentReceiptRequest(
    val email: String? = null,
    val phone: String? = null,
    val securityDepositId: String? = null,
    val giftCardReceipt: Boolean? = null
)
