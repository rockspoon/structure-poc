...
/**
 * CreateProspectRequest represents the prospect creation request
 *
 * @param cardHolderName Name of the credit card holder
 * @param emails List of emails link to this credit card holder, can be
 *     empty
 * @param phones List of phone number link to this credit card holder, can
 *     be empty
 * @param redactedCardNumber The first 4 and last 4 digits of the credit
 *     card
 */
@Serializable
data class CreateProspectRequest(
    /** Name of the credit card holder */
    val cardHolderName: String,
    /** The first 4 and last 4 digits of the credit card */
    val redactedCardNumber: String,
    /** List of emails link to this credit card holder, can be empty */
    val emails: List<String>? = null,
    /** List of phone number link to this credit card holder, can be empty */
