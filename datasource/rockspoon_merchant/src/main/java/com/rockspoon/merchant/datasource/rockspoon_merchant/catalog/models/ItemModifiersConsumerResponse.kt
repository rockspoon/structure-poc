...
/**
 * ItemModifiersConsumerResponse is the response for item modifiers
 *
 * @param modifiers
 */
@Serializable
data class ItemModifiersConsumerResponse(
    val modifiers: List<ListItemModifierResponse>? = null
)
