...
/**
 * CreateIDResponse represents an ID of just created entity
 *
 * @param id id of the created entity
 * @param checkId check id of the created entity
 * @param orderShortId
 */
@Serializable
data class CommitCartResponse(
    /** id of the created entity */
    val id: String? = null,
    /** check id of the created entity */
