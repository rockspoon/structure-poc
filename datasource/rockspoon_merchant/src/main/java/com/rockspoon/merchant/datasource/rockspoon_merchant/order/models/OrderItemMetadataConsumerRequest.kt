...
/**
 * OrderItemMetadataConsumerRequest represents the metadata of an order
 * item
 *
 ...
 */
@Serializable
data class OrderItemMetadataConsumerRequest(
    ...
    val bundleItems: List<BundleItemConsumerRequest>? = null
)
