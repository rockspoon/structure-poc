...
/**
 * DeliveryCustomerRequest represents a delivery customer with his/her
 * address
 *
 * @param id required if name or phone is null
 * @param name required if id is null
 * @param phoneNumber optional, order customer can be created just with a
 *     name
 * @param address
 */
@Serializable
data class DeliveryCustomerRequest(
    /** required if name or phone is null */
    val id: String? = null,
    /** required if id is null */
    val name: String? = null,
    /** optional, order customer can be created just with a name */
