...
/**
 * @param restaurantBundleItemId ID of the restaurant bundle order item
 *     fired
 * @param status
 */
@Serializable
data class FireOrderItemResponseRestaurantBundleItemStatuses(
    /** ID of the restaurant bundle order item fired */
    val restaurantBundleItemId: String? = null,
    val status: RestaurantOrderItemStatus? = null
)
