...
/**
 * ThirdPartyDelivery represents the attributes needed to create a delivery
 * order from a third-party service
 *
 * @param externalId Identifier from the third-party service
 * @param thirdPartyDeliveryId ObjectID that identifies third-party service
 */
@Serializable
data class ThirdPartyDelivery(
    /** Identifier from the third-party service */
    val externalId: String,
    /** ObjectID that identifies third-party service */
    val thirdPartyDeliveryId: String
)
