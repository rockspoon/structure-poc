...
/**
 * @param type
 * @param hiResolutionDto
 * @param loResolutionDto
 * @param noResolutionDto
 */
@Serializable
data class ImageResponse(
    val type: String? = null,
    val hiResolutionDto: ResolutionDto? = null,
    val loResolutionDto: ResolutionDto? = null,
    val noResolutionDto: ResolutionDto? = null
)
