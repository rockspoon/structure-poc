...
/**
 * @param type
 * @param items Array of bundle items in the root of the bundle.
 * @param sections Array of bundle section in the root of the bundle.
 */
@Serializable
data class BundleAttributesDigestResponse(
    val type: BundleType? = null,
    /** Array of bundle items in the root of the bundle. */
    val items: List<BundleItemDigestResponse>? = null,
    /** Array of bundle section in the root of the bundle. */
    val sections: List<BundleSectionDigestResponse>? = null
)
