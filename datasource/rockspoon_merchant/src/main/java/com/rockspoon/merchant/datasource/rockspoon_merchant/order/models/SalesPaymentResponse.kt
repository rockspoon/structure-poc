...
/**
 * Sales payment response struct
 *
 * @param paymentMethod
 * @param quantity represent count of payments for this type
 * @param total represent total amout
 */
@Serializable
data class SalesPaymentResponse(
    val paymentMethod: PaymentMethod? = null,
    /** represent count of payments for this type */
    val quantity: Int? = null,
    /** represent total amout */
    val total: Int? = null
) {

    /** Values: cardpresent,cash,cardnotpresent,`external`,loyalty */
    @Serializable
