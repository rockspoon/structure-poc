...
/**
 * CreatePayByLinkResponse creates shadow user, generates shadow user token
 * and returns payment link with generated token.
 *
 * @param link
 * @param shadowUserId
 */
@Serializable
data class CreatePayByLinkResponse(
    val link: String,
