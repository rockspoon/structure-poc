...
/**
 * UpdateCheckPaymentStatusesRequest represents the check payment status
 * batch update request structure
 *
 * @param checkPaymentStatuses
 */
@Serializable
data class UpdateCheckPaymentStatusesRequest(
    val checkPaymentStatuses: List<UpdateCheckPaymentStatusRequest>
)
