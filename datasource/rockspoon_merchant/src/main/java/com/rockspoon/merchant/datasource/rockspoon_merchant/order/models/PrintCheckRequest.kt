...
/**
 * request json to print order check(or checks). For empty slice will
 * return all checks for this orderId
 *
 * @param checkIds
 * @param onPaper
 */
@Serializable
data class PrintCheckRequest(
    val checkIds: List<String>? = null,
    val onPaper: Boolean? = null
)
