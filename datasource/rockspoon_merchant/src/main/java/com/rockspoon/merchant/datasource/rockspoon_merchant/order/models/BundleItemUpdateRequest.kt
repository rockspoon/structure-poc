...
/**
 * @param restaurantBundleItemId ID of the bundle item in the restaurant.
 *     If empty creates a new bundle item.
 * @param bundleItemId ID of the bundle item, as returned by the menu
 *     digest. Only when creating a new bundle item.
 * @param bundleSectionId ID of the bundle section this item belongs to.
 *     Only when creating a new bundle item.
 * @param modifierSelections Modifiers selection for this bundle item.
 * @param customModifiersSelections Custom modifiers selection for this
 *     bundle item.
 * @param index Index number of the bundle item
 * @param course Course number of the bundle item.
 * @param quantity
 */
@Serializable
data class BundleItemUpdateRequest(
    /**
     * ID of the bundle item in the restaurant. If empty creates a new bundle
     * item.
     */
    val restaurantBundleItemId: String? = null,
    /**
     * ID of the bundle item, as returned by the menu digest. Only when
     * creating a new bundle item.
     */
    val bundleItemId: String? = null,
    /**
     * ID of the bundle section this item belongs to. Only when creating a new
     * bundle item.
     */
    val bundleSectionId: String? = null,
    /** Modifiers selection for this bundle item. */
    val modifierSelections: List<ModifierSelectionRequest>? = null,
    /** Custom modifiers selection for this bundle item. */
    val customModifiersSelections: List<CustomModifiersSelectionRequest>? = null,
    /** Index number of the bundle item */
    val index: String? = null,
    /** Course number of the bundle item. */
