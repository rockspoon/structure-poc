...
/**
 * ModifierSelectionRequest represents all modifiers selected
 *
 * @param modifierId ID of the modifier
 * @param modifierOptionIds List of the selected options for the given
 *     modifier
 */
@Serializable
data class ModifierSelectionRequest(
    ...
    /** List of the selected options for the given modifier */
