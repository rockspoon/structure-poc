...
/**
 * @param floorPlanSectionId The floor plan section id
 * @param floorPlanElementIDs The floor plan elements id for the section
 */
@Serializable
data class OrderMetaInfoFloorPlanLocation(
    /** The floor plan section id */
    val floorPlanSectionId: String? = null,
    /** The floor plan elements id for the section */
