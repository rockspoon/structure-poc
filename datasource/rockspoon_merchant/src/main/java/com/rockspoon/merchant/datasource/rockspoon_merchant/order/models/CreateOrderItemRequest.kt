...
/**
 * CreateOrderItemRequest represents an order item to be added to an order
 *
 * @param itemId ID of the item
 * @param quantity number of items
 * @param orderCustomerIds list of the customers associated with this
 *     orderitem, if this is a consumer request this field should be empty
 * @param metadata
 * @param course course number
 * @param numberOfPlates number of plates to bring with order item
 * @param numberOfSeats how many seats this item will serve
 * @param toGo
 * @param servingOption
...
data class CreateOrderItemRequest(
    ...
    /**
     * list of the customers associated with this orderitem, if this is a
     * consumer request this field should be empty
     */
    val orderCustomerIds: List<String>? = null,
    val metadata: OrderItemMetaDataRequest? = null,
    /** course number */
    val course: Int? = null,
    /** number of plates to bring with order item */
    val numberOfPlates: Int? = null,
    /** how many seats this item will serve */
    val numberOfSeats: Int? = null,
    val toGo: Boolean? = null,
    val servingOption: ServingOptionDto? = null,
    val customerAllergens: List<CustomerAllergenRequest>? = null
)
