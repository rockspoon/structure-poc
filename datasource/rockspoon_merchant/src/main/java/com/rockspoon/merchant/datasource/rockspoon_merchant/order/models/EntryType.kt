...
/**
 * EntryType represents the pay detail type. Values:
 * orderItem,serviceCharges,discount,tax,deliveryFee,extraFee,modifier,extraFeeBefore,extraFeeAfter,modifierOption
 */
@Serializable
enum class EntryType(val value: String) {

    @SerialName("order_item")
    ORDERITEM("order_item"),

    @SerialName("service_charges")
    ...
    @SerialName("extra_fee")
    EXTRA_FEE("extra_fee"),

    @SerialName("modifier")
    MODIFIER("modifier"),

    @SerialName("extra_fee_before")
    EXTRA_FEE_BEFORE("extra_fee_before"),

    @SerialName("extra_fee_after")
    EXTRA_FEE_AFTER("extra_fee_after"),

    @SerialName("modifier_option")
