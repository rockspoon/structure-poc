...
/**
 * pricing got itemModifier
 *
 * @param chosenOptionsUpTo
 * @param sizePrices
 */
@Serializable
data class ItemModifierPricingDigestResponse(
    val chosenOptionsUpTo: Int,
    val sizePrices: List<ItemModifierSizePricesDigestResponse>
)
