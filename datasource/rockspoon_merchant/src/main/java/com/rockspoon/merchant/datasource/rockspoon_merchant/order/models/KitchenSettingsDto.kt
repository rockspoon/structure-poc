...
/**
 * @param printItemOnReady
 * @param kitchenEnable set if the kitchen is enable for the venue
 * @param printItemLabels
 * @param bagItemsInKitchen
 */
@Serializable
data class KitchenSettingsDto(
    val printItemOnReady: Boolean,
    /** set if the kitchen is enable for the venue */
    val kitchenEnable: Boolean,
    val printItemLabels: Boolean,
    val bagItemsInKitchen: Boolean,
    val deliveryTakeoutRunnerDevice: Boolean
)
