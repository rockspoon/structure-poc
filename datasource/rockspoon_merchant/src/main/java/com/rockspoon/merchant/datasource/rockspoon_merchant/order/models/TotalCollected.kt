...
/**
 * aggregated collected values
 *
 * @param giftCardsSold
 * @param giftCardsUsed
 * @param securityDepositCollected
 * @param securityDepositUsed
 ...
 */
@Serializable
data class TotalCollected(
    val giftCardsSold: String? = null,
    val giftCardsUsed: String? = null,
    val securityDepositCollected: String? = null,
    val securityDepositUsed: String? = null,
    val serviceCharges: String? = null,
    val tax: String? = null,
    val extraFees: String? = null,
