...
/**
 * bundle items of restaurant order
 *
 * @param name
 * @param description
 * @param course
 ...
 * @param customModifierSelections
 * @param isComp
 * @param quantity
 * @param isAvailable
...
data class BundleItem(
    ...
    val status: RestaurantOrderItemStatus,
    val restaurantBundleItemId: String,
    val bundleItemId: String,
    val itemId: String,
    val bundleSectionId: String,
    val modifierSelections: List<ModifierSelection>,
    val customModifierSelections: List<CustomModifiersSelectionResponse>,
