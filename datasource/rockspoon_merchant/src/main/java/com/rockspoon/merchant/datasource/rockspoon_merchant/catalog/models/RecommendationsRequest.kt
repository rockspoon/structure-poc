...
/**
 * data that helps server to calculate recommended amount of devices for
 * the restaurant
 *
 * @param floors
 * @param kitchens
 * @param stationsPerKitchen
 * @param seats
 * @param tables
 * @param bars
 * @param fixedPos
 * @param printerPerStation
 * @param hosts
 * @param runners
 * @param waitersPerShift
 * @param waitersOver45
 */
@Serializable
data class RecommendationsRequest(
    ...
    val stationsPerKitchen: Int? = null,
    val seats: Int? = null,
    val tables: Int? = null,
    val bars: Int? = null,
    val fixedPos: Int? = null,
    val printerPerStation: Boolean? = null,
    val hosts: Boolean? = null,
    val runners: Int? = null,
    val waitersPerShift: Int? = null,
    val waitersOver45: Int? = null
)
