...
/**
 * PatchCurbsideRequest represents patch curbside request
 *
 * @param scheduledTime
 * @param comment
 * @param preparationTime preparation time in seconds
 * @param isASAP
 * @param consumerArrived
 ...
 */
@Serializable
data class CurbsidePatchRequest(
    val scheduledTime: Instant? = null,
    val comment: String? = null,
    /** preparation time in seconds */
    val preparationTime: Int? = null,
    val isASAP: Boolean? = null,
    val consumerArrived: Boolean? = null,
    val consumerDocument: ConsumerDocumentRequest? = null,
