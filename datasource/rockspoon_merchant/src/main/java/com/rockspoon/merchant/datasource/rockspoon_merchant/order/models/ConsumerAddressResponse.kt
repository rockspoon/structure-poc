...
/**
 * ConsumerAddressResponse represents the response to a customer address
 * for consumer view
 *
 * @param city
 * @param country
 ...
 * @param name
 * @param status
 * @param timezone Timezone in the timezone database format
 */
@Serializable
data class ConsumerAddressResponse(
    ...
    /** Timezone in the timezone database format */
