...
/**
 * @param email email or phone shouldn't be empty.
 * @param phone email or phone shouldn't be empty.
 * @param securityDepositId securityDepositId is optional.
 */
@Serializable
data class SendReceiptRequest(
    /** email or phone shouldn't be empty. */
    val email: String? = null,
    /** email or phone shouldn't be empty. */
    val phone: String? = null,
    /** securityDepositId is optional. */
    val securityDepositId: String? = null
)
