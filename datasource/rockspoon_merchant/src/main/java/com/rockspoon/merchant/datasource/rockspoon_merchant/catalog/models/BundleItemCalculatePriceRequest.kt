...
/**
 * BundleItemCalculatePriceRequest represents bundle item info.
 *
 * @param bundleItemId
 ...
 */
@Serializable
data class BundleItemCalculatePriceRequest(
    val bundleItemId: String,
    val bundleSectionId: String? = null,
    val modifiers: List<ModifierCalculatePriceRequest>? = null
)
