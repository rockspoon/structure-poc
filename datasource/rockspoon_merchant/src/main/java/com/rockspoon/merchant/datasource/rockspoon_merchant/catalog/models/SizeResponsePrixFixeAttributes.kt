...
/**
 * @param foodQuantity Quantity of food items allowed inside bundle
 * @param beverageQuantity Quantity of beverage items allowed inside bundle
 */
@Serializable
data class SizeResponsePrixFixeAttributes(
    /** Quantity of food items allowed inside bundle */
    @Serializable(with = BigDecimalSerializer::class)
    val foodQuantity: java.math.BigDecimal? = null,
    /** Quantity of beverage items allowed inside bundle */
    @Serializable(with = BigDecimalSerializer::class)
    val beverageQuantity: java.math.BigDecimal? = null
)
