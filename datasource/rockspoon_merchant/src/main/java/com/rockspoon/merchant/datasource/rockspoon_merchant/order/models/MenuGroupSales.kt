...
/**
 * Represent aggregation by menu and section name
 *
 * @param menuName menu name
 * @param quantity represent count of menus
 * @param total represent total amout for menu
 * @param sectionSales
 */
@Serializable
data class MenuGroupSales(
    /** menu name */
    val menuName: String? = null,
    /** represent count of menus */
    val quantity: String? = null,
    /** represent total amout for menu */
    val total: String? = null,
    val sectionSales: List<SectionSale>? = null
)
