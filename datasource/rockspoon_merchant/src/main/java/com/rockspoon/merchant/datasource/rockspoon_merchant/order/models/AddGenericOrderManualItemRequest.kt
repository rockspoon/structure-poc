...
/**
 * AddOrderManualItemRequest represents a cart manual item
 *
 * @param course
 * @param toGo
 ...
 */
@Serializable
data class AddGenericOrderManualItemRequest(
    val customModifiersSelections: List<CustomModifiersSelectionRequest>,
    val name: String,
