...
/**
 * @param thirdParty flag that shows if order cam from the 3rd party
 *     service
 * @param scheduledTime supported format is \"2006-01-02T15:04:05Z\"
 * @param addressId
 * @param venueId
 * @param comment
 * @param domain
 */
@Serializable
data class DeliveryRequestConsumer(
    val venueId: String,
    /** flag that shows if order cam from the 3rd party service */
    val thirdParty: Boolean? = null,
    /** supported format is \"2006-01-02T15:04:05Z\" */
