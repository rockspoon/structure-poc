...
/**
 * OrderItemUpdateMetadataRequest represents the order item update metadata
 * request structure
 *
 * @param modifierSelections
 * @param customModifiersSelections
 * @param bundleItems
 * @param sizeId Size ID of the item that this modifier refers to
 */
@Serializable
data class OrderItemUpdateMetadataRequest(
    ...
    val bundleItems: List<BundleItemUpdateRequest>? = null,
    /** Size ID of the item that this modifier refers to */
