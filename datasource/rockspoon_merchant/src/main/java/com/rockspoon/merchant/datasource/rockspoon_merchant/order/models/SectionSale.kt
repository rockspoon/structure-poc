...
/**
 * Represent aggregation by sections for current menuName
 *
 * @param sectionName section name
 * @param quantity represent count of sections
 * @param total represent total amount for section
 */
@Serializable
data class SectionSale(
    /** section name */
    val sectionName: String? = null,
    /** represent count of sections */
    val quantity: String? = null,
    /** represent total amount for section */
