 ...
 * @param minTimeCase
 * @param maxTimeCase
 * @param minOccupancyCase
 * @param maxOccupancyCase
 * @param fee
 */
@Serializable
data class CustomFeeProgressiveValue(
    val fee: CustomProgressiveFee,
    val minTimeCase: TimeProgressiveValue? = null,
    val maxTimeCase: TimeProgressiveValue? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val minOccupancyCase: BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val maxOccupancyCase: BigDecimal? = null
)
