...
/**
 * Values sales report aggregated values
 *
 * @param fees
 * @param netTotal
 * @param totalTransferToBank
 * @param orderTypes
 * @param summary
 * @param totalCollected
 * @param paymentTypes
 * @param itemGroupSales
 * @param menuGroupSales
 * @param categorySales
 * @param customers
 */
@Serializable
data class ReportValues(
    ...
    val totalTransferToBank: String? = null,
    val orderTypes: List<OrderTypes>? = null,
    val summary: Summary? = null,
    val totalCollected: TotalCollected? = null,
    val paymentTypes: List<SalesPaymentResponse>? = null,
    val itemGroupSales: List<ItemGroupSale>? = null,
    val menuGroupSales: List<MenuGroupSales>? = null,
    val categorySales: List<CategorySales>? = null,
    val customers: CustomersAggregationResponse? = null
)
