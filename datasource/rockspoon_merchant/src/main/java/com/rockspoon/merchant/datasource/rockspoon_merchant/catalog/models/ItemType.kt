...
/**
 * Values: FOOD, NONALCOHOLICBEVERAGE, ALCOHOLICBEVERAGE, MENU,
 * PREPPEDFOOD, INVENTORY, SIDE, BUNDLE, FIXPOS, ROUTER, ROUTEREXTENDER,
 * PRINTER, PAPERPRINTER, LABELPRINTER, LABELPAPER, PAYMENTTABLET,
 * MOBILEPOS, BARPOS, SMALLPOS, STANDTAB, MOUNT, CHARGER
 */
@Serializable
enum class ItemType(val value: String) {
    ...
    @SerialName("router_extender")
    ROUTER_EXTENDER("router_extender"),

    @SerialName("printer")
    PRINTER("printer"),

    @SerialName("paper_printer")
    PAPER_PRINTER("paper_printer"),

    @SerialName("label_printer")
    LABEL_PRINTER("label_printer"),

    @SerialName("label_paper")
    LABEL_PAPER("label_paper"),

    @SerialName("payment_tablet")
    PAYMENT_TABLET("payment_tablet"),
    ...
    @SerialName("small_pos")
    SMALL_POS("small_pos"),

    @SerialName("stand_tab")
    STAND_TAB("stand_tab"),
