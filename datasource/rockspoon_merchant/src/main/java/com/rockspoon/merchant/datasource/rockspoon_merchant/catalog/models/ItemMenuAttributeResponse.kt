...
/**
 * ItemMenuAttributeResponse is the item menu attribute response
 *
 * @param index
 * @param isVariablePrice
 * @param menuId
 * @param menuSectionId
 * @param menuVId
 * @param menuType
 * @param reference name of the menu version that is being returned
 * @param price
 * @param splitPricingType
 */
@Serializable
data class ItemMenuAttributeResponse(
    val index: Long,
    val isVariablePrice: Boolean,
    val menuId: String,
    val menuSectionId: String,
    val menuVId: String,
    val menuType: MenuType,
    val price: Long,
    val splitPricingType: SplitPricingType,
    /** name of the menu version that is being returned */
