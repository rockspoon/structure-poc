...
/**
 * Request for place consumer order
 *
 * @param downpaymentAmount Downpayment amount (in cents)
 * @param cctoken Token of the credit card to be used for downpayment
 * @param billingPeriod Time in months that the sub-merchant will be able
 *     to choose to pay the total purchase amount
 */
@Serializable
data class PlaceOrderConsumerRequest(
    /** Downpayment amount (in cents) */
    val downpaymentAmount: Int,
    /** Token of the credit card to be used for downpayment */
    val cctoken: String,
    /**
     * Time in months that the sub-merchant will be able to choose to pay the
     * total purchase amount
     */
    val billingPeriod: Int? = null
)
