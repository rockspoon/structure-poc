...
data class OrderMoneySummary(
    val subTotal: SimpleMoney? = null,
    val discounts: SimpleMoney? = null,
    val total: SimpleMoney? = null,
    val tips: SimpleMoney? = null,
    val serviceCharges: SimpleMoney? = null,
    val fees: SimpleMoney? = null,
    val taxes: SimpleMoney? = null,
    val balance: SimpleMoney? = null,
    val extraFees: SimpleMoney? = null
)
