...
/**
 * CustomFeeFactor represents the custom fee factor Values:
 * tableSize,weekDay,hourOfTheWeekday,hourOfTheDay
 */
@Serializable
enum class CustomFeeFactor(val value: String) {

    @SerialName("tableSize")
    TABLESIZE("tableSize"),

    @SerialName("weekDay")
    WEEKDAY("weekDay"),

    @SerialName("hourOfTheWeekday")
    HOUROFTHEWEEKDAY("hourOfTheWeekday"),

    @SerialName("hourOfTheDay")
