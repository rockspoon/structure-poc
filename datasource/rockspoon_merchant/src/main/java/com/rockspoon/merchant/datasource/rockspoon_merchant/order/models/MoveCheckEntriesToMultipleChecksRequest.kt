...
/**
 * represents request model to move check entries to multiple checks
 *
 * @param checkWithEntries
 */
@Serializable
data class MoveCheckEntriesToMultipleChecksRequest(
    val checkWithEntries: List<CheckWithEntriesRequest>? = null
)
