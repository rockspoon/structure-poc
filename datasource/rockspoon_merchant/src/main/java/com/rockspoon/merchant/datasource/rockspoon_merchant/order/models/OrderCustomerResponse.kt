...
/**
 * OrderCustomerResponse represent an customer details
 *
 * @param id
 * @param customerID
 * @param name
 ...
 * @param shadowUserId
 * @param isConsumerApp
 * @param autopayConsumerApp
 * @param autopayDisabledReason
 * @param status
 * @param customerVenueId
 * @param customerVenueName
 */
@Serializable
data class OrderCustomerResponse(
    ...
    val shadowUserId: String? = null,
    val isConsumerApp: Boolean? = null,
    val autopayConsumerApp: Boolean? = null,
    val autopayDisabledReason: String? = null,
    val status: String? = null,
    val customerVenueId: String? = null,
    val customerVenueName: String? = null
)
