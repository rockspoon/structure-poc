...
/**
 * @param maxSeatByTable Maximum number of seats that are allowed to be
 *     filled per table
 * @param isActive Set if the covid settings are active
 */
@Serializable
data class VenueCovidOptions(
    /** Maximum number of seats that are allowed to be filled per table */
    val maxSeatByTable: String? = null,
    /** Set if the covid settings are active */
