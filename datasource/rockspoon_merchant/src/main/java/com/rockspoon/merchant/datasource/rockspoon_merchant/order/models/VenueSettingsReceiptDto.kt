 ...
 */
@Serializable
data class VenueSettingsReceiptDto(
    val fontSize: VenueSettingsFontSizeDto? = null,
    val displayPayByLink: Boolean? = null,
    val printedCustomText: VenueSettingsCustomTextDto? = null,
    val emailCustomText: VenueSettingsCustomTextDto? = null,
