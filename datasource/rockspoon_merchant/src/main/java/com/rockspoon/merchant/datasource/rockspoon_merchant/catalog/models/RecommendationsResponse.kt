...
/**
 * array of recommended devices
 *
 * @param id item ID
 * @param title title of the item
 * @param count recommended number of devices
 * @param photos
 * @param sizesAndPrices price of the item
 */
@Serializable
data class RecommendationsResponse(
    ...
    /** price of the item */
    val sizesAndPrices: List<DeviceSizeResponse>? = null
)
