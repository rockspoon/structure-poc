 ...
 */
@Serializable
data class MenuVersionResponse(
    val availability: List<MenuAvailabilityResponse>? = null,
    val availableFor: List<MenuAvailableForServices>? = null,
    ...
    val sections: List<MenuSectionResponse>? = null
)
