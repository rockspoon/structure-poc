...
/**
 * Patchs orderItems, can update their course or customers (at least one of
 * them is necessary)
 *
 * @param toGo
 * @param orderItemIds array of order items to be updated
 * @param orderCustomerIds array of the new customer ids, can't be empty if
 *     the course is nil. If empty it remains unchanged.
 * @param orderBundleItemIds array of bundle items to be updated
 ...
 *     and 64. A course 0 means no course. Can't be empty if the
 *     orderCustomerIds is nil. If empty it remains unchanged.
 */
@Serializable
data class OrderItemPatchRequest(
    /** array of order items to be updated */
    val orderItemIds: List<String>,
    val toGo: Boolean? = null,
    /**
     * array of the new customer ids, can't be empty if the course is nil. If
     * empty it remains unchanged.
     */
    val orderCustomerIds: List<String>? = null,
    /** array of bundle items to be updated */
    val orderBundleItemIds: List<String>? = null,
    /**
     ...
     * means no course. Can't be empty if the orderCustomerIds is nil. If empty
