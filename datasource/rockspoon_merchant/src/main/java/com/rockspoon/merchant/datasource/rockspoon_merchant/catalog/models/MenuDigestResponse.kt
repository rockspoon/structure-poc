...
/**
 * MenuDigestResponse is a menu digest response
 *
 * @param availableFor
 * @param color
 * @param description
 ...
 * @param lastUnpublishedAt
 */
@Serializable
data class MenuDigestResponse(
    val availableFor: List<MenuAvailableForServices>,
    val color: String,
    val description: String,
    val index: Long,
    val itemCount: Long,
    val items: List<ItemDigestResponse>,
    val menuId: String,
    val versionId: String,
    val reference: String,
    val sectionCount: Long,
    val sections: List<SectionDigestResponse>,
    val status: MenuStatus,
    val title: String,
    val createdAt: kotlinx.datetime.Instant? = null,
    val lastDraftAt: kotlinx.datetime.Instant? = null,
    val lastPublishedAt: kotlinx.datetime.Instant? = null,
    val lastUnpublishedAt: kotlinx.datetime.Instant? = null
)
