 ...
 * @param comps
 * @param compsCount
 * @param securityDepositExpired
 */
@Serializable
data class Summary(
    val discounts: String? = null,
    val giftCardsExpired: String? = null,
    val grossSales: String? = null,
    val netRevenue: String? = null,
    val refunds: String? = null,
    val refundsCount: String? = null,
    val comps: String? = null,
    val compsCount: String? = null,
    val securityDepositExpired: String? = null
)
