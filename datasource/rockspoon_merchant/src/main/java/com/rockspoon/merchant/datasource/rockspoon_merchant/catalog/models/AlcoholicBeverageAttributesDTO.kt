 ...
 * @param series
 * @param &#x60;package&#x60;
 * @param alcoholByVolume
 * @param age
 * @param vintage
 * @param grape
 */
@Serializable
data class AlcoholicBeverageAttributesDTO(
    ...
    @SerialName("package")
    val alcoholicBeveragePackage: AlcoholicBeveragePackageDTO? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val alcoholByVolume: java.math.BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val age: java.math.BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val vintage: java.math.BigDecimal? = null,
    val grape: List<GrapeDescriptionDTO>? = null
)
