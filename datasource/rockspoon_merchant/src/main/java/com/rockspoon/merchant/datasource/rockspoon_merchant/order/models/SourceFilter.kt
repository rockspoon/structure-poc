...
/**
 * SourceFilter is a source order filter type. Values:
 * restaurant,device_marketplace,e_commerce
 */
@Serializable
enum class SourceFilter(val value: String) {
    ...
    @SerialName("device-marketplace")
    DEVICE_MARKETPLACE("device-marketplace"),
