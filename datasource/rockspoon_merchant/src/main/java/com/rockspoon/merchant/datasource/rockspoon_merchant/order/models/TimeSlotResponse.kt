...
/**
 * Represents time intervals for each day when the order can be created for
 * the restaurant. The lenght of the interval depends on venue interval
 * configuration.
 *
 * @param date
 * @param periods
...
data class TimeSlotResponse(
    ...
    val periods: List<TimeSlotPeriod>? = null
)
