...
/**
 * OrderItemConsumerRequest represents a request to create a new orderitem
 * from the consumerApp
 *
 * @param course
 * @param itemId
 * @param toGo
 ...
 */
@Serializable
data class OrderItemConsumerRequest(
    val itemId: String,
    val menuId: String,
    val sizeId: String,
    val metadata: OrderItemMetadataConsumerRequest,
    val quantity: String,
    val course: String? = null,
    val toGo: Boolean? = null,
    val sectionId: String? = null,
    val servingOption: PatchCAPaymentInfoTips? = null
)
