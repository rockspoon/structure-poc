...
/**
 * Represent customers aggregation response
 *
 * @param customersCount represent count of customers
 * @param averageRevenue represent total / customersCount
 * @param totalCovers count of items that were fired in the period
 *     (excluding items that were voided)
 * @param averageCovers represent totalCovers / customerCount
 */
@Serializable
data class CustomersAggregationResponse(
    /** represent count of customers */
    val customersCount: String? = null,
    /** represent total / customersCount */
    val averageRevenue: String? = null,
    /**
     * count of items that were fired in the period (excluding items that were
     * voided)
     */
    val totalCovers: String? = null,
    /** represent totalCovers / customerCount */
    val averageCovers: String? = null
)
