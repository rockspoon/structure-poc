...
/**
 * CalculateItemsPriceRequest represent request to calculate prices for
 * list of items
 *
 * @param venueId
 * @param items
 */
@Serializable
data class CalculateItemsPriceRequest(
    val venueId: String,
    val items: List<CalculateItemPriceRequest>? = null
)
