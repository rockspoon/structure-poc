...
/**
 * SplitPricingType represents all possible split pricing types for pizza
 * bundle. Values: HIGHEST, PRO_RATA, CUSTOM
 */
@Serializable
enum class SplitPricingType(val value: String) {
