...
/** @param maximumDivisions Maximum pizza divisions */
@Serializable
data class SizeResponsePizzaAttributes(
    /** Maximum pizza divisions */
    @Serializable(with = BigDecimalSerializer::class)
    val maximumDivisions: java.math.BigDecimal? = null
)
