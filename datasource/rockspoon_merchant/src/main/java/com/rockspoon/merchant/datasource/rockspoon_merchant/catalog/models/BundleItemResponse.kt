...
/**
 * @param id ID of the bundle item
 * @param itemId Item ID that will be part of this bundle
 * @param sizeId Size ID of the item that will be part of this bundle.
 * @param title Bundle Item title
 * @param description Bundle Item description
 * @param tags
 * @param photos
 */
@Serializable
data class BundleItemResponse(
    ...
    val id: String? = null,
    /** Item ID that will be part of this bundle */
    val itemId: String? = null,
    /** Size ID of the item that will be part of this bundle. */
