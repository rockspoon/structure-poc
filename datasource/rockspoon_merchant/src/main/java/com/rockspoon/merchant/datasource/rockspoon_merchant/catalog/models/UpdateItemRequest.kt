 ...
 * @param title
 * @param type
 * @param globalId The id of the item in the global-catalog
 * @param meta
 * @param itemCategory
 * @param taxRule
 */
...
data class UpdateItemRequest(
    ...
    val title: String,
    val type: List<Facet>,
    val alcoholicAttributes: AlcoholicAttributesRequest? = null,
    val beverageAttributes: BeverageAttributesRequest? = null,
    val groceryAttributes: GroceryAttributesRequest? = null,
    val bundleAttributes: BundleAttributesRequest? = null,
    val availability: List<ItemAvailabilityRequest>? = null,
    val course: Long? = null,
    val description: String? = null,
    val origin: ItemOriginRequest? = null,
    val sizesAndPrices: List<UpdateSizeRequest>? = null,
    val subcategory: ItemSubtype? = null,
    /** The id of the item in the global-catalog */
