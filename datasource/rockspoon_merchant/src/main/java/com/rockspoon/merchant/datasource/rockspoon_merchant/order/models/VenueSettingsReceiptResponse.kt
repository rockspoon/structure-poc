...
/**
 * @param fontSize
 * @param printOnReceive
 * @param printOnReadyForPickup
 * @param displayPayByLink
 * @param printedCustomText
 * @param emailCustomText
 */
@Serializable
data class VenueSettingsReceiptResponse(
    val fontSize: VenueSettingsFontSizeResponse? = null,
    val printOnReceive: Boolean? = null,
    val printOnReadyForPickup: Boolean? = null,
    val displayPayByLink: Boolean? = null,
    val printedCustomText: VenueSettingsCustomTextResponse? = null,
    val emailCustomText: VenueSettingsCustomTextResponse? = null
)
