 ...
 * @param maxOccupancy
 * @param createdAt
 * @param isOrderCustomer true, if the user is already assigned to the
 *     table
 * @param diners
 */
@Serializable
data class CWGuestDineInResponse(
    val orderId: String? = null,
    val maxOccupancy: Int? = null,
    val createdAt: Instant? = null,
    /** true, if the user is already assigned to the table */
    val isOrderCustomer: Boolean? = null,
    val diners: List<CWGuestDineInDinerResponse>? = null
)
