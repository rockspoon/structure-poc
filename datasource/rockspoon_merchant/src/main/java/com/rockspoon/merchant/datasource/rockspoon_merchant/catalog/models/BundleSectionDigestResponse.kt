...
/**
 * returns info about certaion bundle section in digest response.
 *
 * @param id
 * @param name
 * @param course
 * @param items array of bundle items inside a section of the bundle
 */
@Serializable
data class BundleSectionDigestResponse(
    val id: String? = null,
    val name: String? = null,
    val course: Long? = null,
    /** array of bundle items inside a section of the bundle */
