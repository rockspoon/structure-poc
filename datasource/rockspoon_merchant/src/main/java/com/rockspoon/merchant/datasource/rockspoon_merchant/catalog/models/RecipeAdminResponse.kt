...
/**
 * Represents Recipe complete info model (you should expect this model to
 * always equal the `github.com/rockspoon/rs.cat.item-model/dto.Recipe`
 * model
 *
 * @param cookingTime
 * @param createdAt
 ...
 */
@Serializable
data class RecipeAdminResponse(
    @Serializable(with = BigDecimalSerializer::class)
    val cookingTime: java.math.BigDecimal? = null,
    val createdAt: Instant? = null,
    val deletedAt: Instant? = null,
    val id: String? = null,
    val instructions: List<RecipeInstructionDTO>? = null,
    val itemId: String? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val platingTime: java.math.BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val preparationTime: java.math.BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val quantity: java.math.BigDecimal? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val serving: java.math.BigDecimal? = null,
    val sizes: List<SizeRecipeDTO>? = null,
