...
/**
 * @param foodSales
 * @param alcoholicBeverageSales
 * @param nonAlcoholicBeverageSales
 * @param discounts
 * @param netSales
 */
@Serializable
data class SalesInfoReponse(
    val foodSales: PriceDto? = null,
    val alcoholicBeverageSales: PriceDto? = null,
    val nonAlcoholicBeverageSales: PriceDto? = null,
    val discounts: PriceDto? = null,
    val netSales: PriceDto? = null
)
