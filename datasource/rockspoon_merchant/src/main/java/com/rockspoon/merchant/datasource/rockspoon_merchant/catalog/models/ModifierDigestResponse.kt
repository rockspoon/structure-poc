...
/**
 * ModifierDigestResponse is a modifier digest response
 *
 * @param modifierId
 * @param pricingOption
 * @param index
 ...
 * @param options
 * @param title
 * @param titleForCustomers
 * @param type
 * @param subtype
 */
@Serializable
data class ModifierDigestResponse(
    val modifierId: String,
    val pricingOption: PricingOption,
    val index: Int,
    val mandatory: Boolean,
    val options: List<ModifierOptionDigestResponse>,
    val title: String,
    val titleForCustomers: String,
    val type: ModifierType,
    val maxModifiers: Int? = null,
    val pricing: List<ItemModifierPricingDigestResponse>? = null,
    val subtype: List<String>? = null
) {

    /** Values: custom,perOption,free */
    @Serializable
    enum class PricingOption(val value: String) {
