 ...
 * @param origin
 * @param alcoholicBeverageAttributes
 * @param beverageAttributes
 */
@Serializable
data class FoodAndBeverageAttributesDTO(
    @Serializable(with = BigDecimalSerializer::class)
    val course: java.math.BigDecimal? = null,
    val routings: List<String>? = null,
    val nutritionalAttributes: List<NutritionalAttributeDTO>? = null,
    val origin: OriginDTO? = null,
    val alcoholicBeverageAttributes: AlcoholicBeverageAttributesDTO? = null,
    val beverageAttributes: BeverageAttributesDTO? = null
)
