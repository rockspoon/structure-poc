...
/**
 * AddOrderManualItemToCardRequest represents a cart request
 *
 * @param items
 */
@Serializable
data class AddGenericOrderManualItemToCardRequest(
    val items: List<AddGenericOrderManualItemRequest>
)
