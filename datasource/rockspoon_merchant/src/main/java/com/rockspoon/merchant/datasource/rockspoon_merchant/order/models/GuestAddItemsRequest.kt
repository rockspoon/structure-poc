...
/**
 * GuestAddItemsRequest represents request model to create items for
 * existing guest diner.
 *
 * @param orderItems
 */
@Serializable
data class GuestAddItemsRequest(
    val orderItems: List<OrderItemConsumerRequest>
)
