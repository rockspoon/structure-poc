...
/**
 * CAOrderFullStatus represents the status of the order
 * considering kitchen and payment information. Values:
 * received,inProgress,readyForDelivery,readyForPickup,outForDelivery,delivered,finished,refunded,deleted,canceled
 */
@Serializable
enum class CAOrderFullStatus(val value: String) {
