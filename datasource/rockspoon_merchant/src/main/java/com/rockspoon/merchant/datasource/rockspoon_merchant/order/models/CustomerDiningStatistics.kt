...
/**
 * CustomerDiningStatistics represents dining statistics for a particular
 * customer
 *
 * @param lastVisit
 * @param numberOfVisits
 * @param avgAmountSpent
 * @param avgPartySize
 */
@Serializable
data class CustomerDiningStatistics(
    val lastVisit: String? = null,
    val numberOfVisits: String? = null,
    val avgAmountSpent: String? = null,
    @Serializable(with = BigDecimalSerializer::class)
    val avgPartySize: BigDecimal? = null
)
