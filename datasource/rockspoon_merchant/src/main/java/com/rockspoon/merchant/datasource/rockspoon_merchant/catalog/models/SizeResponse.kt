...
/**
 * SizeResponse is the response for sizes
 *
 * @param id
...
data class SizeResponse(
    val id: String,
    val menuAttributes: List<ItemMenuAttributeResponse>,
    val name: String,
    val pizzaAttributes: SizeResponsePizzaAttributes? = null,
    val comboAttributes: SizeResponseComboAttributes? = null,
    val prixFixeAttributes: SizeResponsePrixFixeAttributes? = null,
    val sushiAttributes: SizeResponseSushiAttributes? = null,
