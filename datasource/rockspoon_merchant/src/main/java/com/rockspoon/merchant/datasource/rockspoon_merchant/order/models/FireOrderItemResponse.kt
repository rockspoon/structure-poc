...
/**
 * FireOrderItemRequest represents the status of the items after firing
 *
 * @param orderItemStatuses
 * @param restaurantBundleItemStatuses
 */
@Serializable
data class FireOrderItemResponse(
    val orderItemStatuses: List<FireOrderItemResponseOrderItemStatuses>? = null,
    val restaurantBundleItemStatuses: List<FireOrderItemResponseRestaurantBundleItemStatuses>? = null
)
