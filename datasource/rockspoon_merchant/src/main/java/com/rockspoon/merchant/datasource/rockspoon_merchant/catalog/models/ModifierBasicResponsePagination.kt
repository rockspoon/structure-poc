...
/**
 * ModifierBasicResponsePagination is the modifier basic response for a
 * paginated list of modifiers
 *
 * @param total
 * @param next
 * @param previous
 ...
 */
@Serializable
data class ModifierBasicResponsePagination(
    val total: Long,
    val next: String,
    val previous: String,
    val results: List<ModifierBasicResponse>
)
