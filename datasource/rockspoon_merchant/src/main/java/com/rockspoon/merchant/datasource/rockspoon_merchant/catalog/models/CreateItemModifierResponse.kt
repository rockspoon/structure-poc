...
/**
 * @param createdModifiersIds
 * @param createdItemModifiersIds
 */
@Serializable
data class CreateItemModifierResponse(
    val createdModifiersIds: List<String>? = null,
    val createdItemModifiersIds: List<String>? = null
)
