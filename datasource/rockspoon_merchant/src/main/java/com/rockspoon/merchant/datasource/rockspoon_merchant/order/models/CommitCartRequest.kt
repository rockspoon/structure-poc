...
/**
 * @param scheduledFor date format 2019-10-20T15:00:00Z, should not be
 *     empty if isASAP is empty
 * @param addressId required for delivery orderType
 * @param address whole address to be used with e-commerce orders
 * @param isASAP should not be empty if scheduledFor is empty
 * @param carInfoDto
 */
@Serializable
data class CommitCartRequest(
    /** date format 2019-10-20T15:00:00Z, should not be empty if isASAP is empty */
    val scheduledFor: Instant? = null,
    /** required for delivery orderType */
    val addressId: String? = null,
    /** whole address to be used with e-commerce orders */
    val address: AddressRequest? = null,
    /** should not be empty if scheduledFor is empty */
    val isASAP: Boolean? = null,
